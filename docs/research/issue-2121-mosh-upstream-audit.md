...
- 在独立 network namespace 中只保留 IPv6、把两端 MTU 设为 1280，并发送难压缩的大画面。抓到 22 个 IPv6 UDP 包，其中服务端发出 14 个、合计 7033 字节；最大 IPv6 包为 1264 字节，未出现 IPv6 Fragment Header，最终画面正确。

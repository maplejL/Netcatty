...
const VAULT_CAPABILITIES = [
  ...
  },
  {
    ...
    domain: "vault",
    status: CAPABILITY_STATUS.IMPLEMENTED,
    description: "Parse known host export file formats (PuTTY, MobaXterm, CSV, SecureCRT, ssh_config, FinalShell) into vault hosts. For arbitrary unstructured text, map to host objects and use vault_hosts_create instead.",
    policy: {
      write: true,
      sensitiveRead: false,
      longRunning: false,

...
export const ruTerminalMessages: Messages = {
  ...
  'history.popup.title': 'История команд',
  'history.popup.searchPlaceholder': 'Введите текст для фильтра…',
  'history.popup.empty': 'История команд пока пуста.',
  'history.popup.emptyFiltered': 'Нет подходящих команд.',
  'history.popup.hints': 'Enter / двойной щелчок — вставить · ↑↓ — выбор · Esc — закрыть',

...
export const ruAiMessages: Messages = {
  ...
  'ai.chat.fast': 'Fast',
  'ai.chat.fastDesc': 'Использовать более быстрый, менее затратный вариант модели, если доступен.',
  'ai.chat.effort': 'Усилие',
  'ai.chat.effortDesc': 'Интенсивность рассуждения / thinking для этой модели.',
  'ai.chat.effortDefault': 'По умолчанию',
  ...
  'codingCli.phase.idle': 'Простой',
  'codingCli.phase.busy': 'Выполняется',
  'codingCli.phase.waiting': 'Ожидание',
  'codingCli.phase.completed': 'Завершено',
  'codingCli.phase.failed': 'Ошибка',

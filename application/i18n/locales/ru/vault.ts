...
export const ruVaultMessages: Messages = {
  ...
  'vault.hosts.connectWorkspace': 'Рабочая область ({count})',
  'vault.hosts.connectWorkspace.success': 'Открытие рабочей области с {count} хостами',
  'vault.hosts.batchExec': 'Пакетная команда ({count})',
  ...
  'sftp.context.insertPathToTerminal': 'Вставить путь в терминал',
  ...
  'sftp.editor.permissionDeniedHint': 'Отказано в доступе. SFTP всё ещё использует пользователя входа. Включите SFTP Sudo для этого хоста или переподключите SFTP после sudo.',
  'sftp.sudo.followedTerminal': 'SFTP переподключён через sudo, чтобы соответствовать терминалу.',
  'sftp.sudo.followFailed': 'Не удалось переподключить SFTP через sudo. Включите SFTP Sudo в настройках хоста и сохраните пароль либо разрешите sudo без пароля.',
  ...
  'sftp.editor.compareMode': 'Сравнение',
  'sftp.editor.exitCompare': 'Выйти из сравнения',
  'sftp.editor.compareWithActive': 'Сравнить с активным редактором',
  ...
  // Quick Switcher
  'qs.search.placeholder': 'Поиск хостов, вкладок или agent-терминалов',
  'qs.jumpTo': 'Перейти к',
  'qs.localTerminal': 'Локальный терминал',
  'qs.localShells': 'Локальные оболочки',
  'qs.default': 'По умолчанию',
  'qs.codingCliHistory': 'История agent-терминалов',
  'qs.codingCliHistoryOpenPanel': 'Открыть историю agent-терминалов',
  'qs.codingCliHistorySection': 'История agent-терминалов',

  // Coding CLI terminal history
  'codingCliHistory.title': 'История agent-терминалов',
  'codingCliHistory.subtitle': 'Закрытые локальные каталоги Claude / Codex / Grok',
  'codingCliHistory.searchPlaceholder': 'Поиск пути, названия или CLI…',
  'codingCliHistory.filterAll': 'Все',
  'codingCliHistory.empty': 'Пока пусто. Запустите coding CLI в локальном терминале — запись появится сама.',
  'codingCliHistory.emptyFiltered': 'Нет подходящих записей.',
  'codingCliHistory.open': 'Открыть локальный терминал здесь',
  'codingCliHistory.jump': 'Быстрый переход (папка + CLI)',
  'codingCliHistory.openShell': 'Только папка',
  'codingCliHistory.hasResume': 'Можно возобновить',
  'codingCliHistory.noResume': 'Нет resume (новый CLI)',
  'codingCliHistory.status.exact': 'Точное возобновление',
  'codingCliHistory.status.continue': 'Продолжить последнее в папке',
  'codingCliHistory.status.fresh': 'Новый CLI в папке',
  'codingCliHistory.remove': 'Удалить',
  'codingCliHistory.pin': 'Закрепить',
  'codingCliHistory.unpin': 'Открепить',
  'codingCliHistory.clearAll': 'Очистить',
  'codingCliHistory.count': 'Сохранено: {n}',
  'codingCliHistory.scanOpen': 'Сканировать терминалы',
  'codingCliHistory.scanning': 'Сканирование…',
  'codingCliHistory.scanDone': 'Сканирование завершено',
  'codingCliHistory.scanResult': 'Найдено {matched} agent(ов) (новых {added}, обновлено {updated})',
  'codingCliHistory.scanResultDetailed': 'Найдено {matched} (в приложении {local} · система {external}; новых {added}, обновлено {updated})',
  'codingCliHistory.scanError': 'Ошибка: {error}',

...
export const ruCoreMessages: Messages = {
  ...
  'settings.terminalCommandTiming.title': 'Тайминг команд терминала',
  'settings.terminalCommandTiming.enable': 'Записывать трассы задержки команд',
  'settings.terminalCommandTiming.enableDesc': 'При включении измеряет submit → write → first output → first render для каждой команды. В DevTools фильтр: terminal-command-timing.',
  'settings.terminalCommandTiming.hint': 'По умолчанию выкл. Трассы только в памяти (кольцевой буфер) и помогают найти, где задержка. Без накладных расходов, когда выкл.',
  'settings.terminalCommandTiming.panelDisabled': 'Включите переключатель выше, чтобы начать запись. Недавние трассы появятся здесь в виде сегментированных полос.',
  'settings.terminalCommandTiming.recentTitle': 'Недавние трассы',
  'settings.terminalCommandTiming.recentDesc': 'Показано {n} · буфер {cap} · активных {active}',
  'settings.terminalCommandTiming.limitOption': 'Последние {n}',
  'settings.terminalCommandTiming.empty': 'Пока нет записей. Выполните команду в терминале и вернитесь сюда.',
  'settings.terminalCommandTiming.emptyFiltered': 'Нет подходящих трасс. Смените хост или поисковый запрос.',
  'settings.terminalCommandTiming.hostAll': 'Все хосты',
  'settings.terminalCommandTiming.searchPlaceholder': 'Поиск: команда / IP / хост…',
  'settings.terminalCommandTiming.clearSearch': 'Очистить поиск',
  'settings.terminalCommandTiming.clear': 'Очистить трассы',
  'settings.terminalCommandTiming.copy': 'Копировать как текст',
  'settings.terminalCommandTiming.copied': 'Скопировано',
  'settings.terminalCommandTiming.copyFailed': 'Не удалось скопировать',
  'settings.terminalCommandTiming.statusActive': 'Выполняется',
  'settings.terminalCommandTiming.endReason': 'Конец',
  'settings.terminalCommandTiming.total': 'всего',
  'settings.terminalCommandTiming.partial': 'пока',
  'settings.terminalCommandTiming.barAria': 'Этапы задержки команды',
  'settings.terminalCommandTiming.bottleneck': 'узкое место',
  ...
  'settings.terminalCommandTiming.segRenderEnd': 'После render',
  'settings.terminalCommandTiming.segIncomplete': 'Незавершено',
  'settings.terminalCommandTiming.hintSubmitWrite': 'Узкое место до IPC write — главный поток / путь ввода.',
  'settings.terminalCommandTiming.hintWriteOutput': 'Узкое место в ожидании первого удалённого вывода — сеть / SSH / хост.',
  'settings.terminalCommandTiming.hintOutputRender': 'Узкое место между первым выводом и отрисовкой xterm — очередь записи / coalescer / render.',
...
`,
  ...
  'settings.shortcuts.conflict.title': 'Сочетание уже занято',
  'settings.shortcuts.conflict.message': '«{key}» уже используется для «{action}». Выберите другое сочетание или освободите текущее.',
  ...
  'settings.shortcuts.binding.open-history': 'Открыть всплывающую историю команд',

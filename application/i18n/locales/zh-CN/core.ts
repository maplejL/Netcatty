...
export const zhCNCoreMessages: Messages = {
  ...
  // Settings > Terminal Command Timing Debug
  'settings.terminalCommandTiming.title': '终端命令耗时调试',
  'settings.terminalCommandTiming.enable': '记录命令耗时轨迹',
  'settings.terminalCommandTiming.enableDesc': '开启后，对每条终端命令记录 提交 → 写入后端 → 首包输出 → 首次渲染 的时间点。在 DevTools 控制台用 terminal-command-timing 过滤查看。',
  'settings.terminalCommandTiming.hint': '默认关闭。轨迹写入本机缓冲（主窗口与设置窗口共享），用于分析输入后卡在哪一环；关闭时无性能开销。',
  'settings.terminalCommandTiming.panelDisabled': '打开上方开关后开始记录。在主窗口终端执行命令后，轨迹会出现在此（设置是独立窗口，数据经本地存储同步）。',
  'settings.terminalCommandTiming.recentTitle': '最近轨迹',
  'settings.terminalCommandTiming.recentDesc': '显示 {n} 条 · 缓冲 {cap} · 进行中 {active}',
  'settings.terminalCommandTiming.limitOption': '最近 {n} 条',
  'settings.terminalCommandTiming.empty': '尚无记录。在任意终端执行命令后回到此处查看。',
  'settings.terminalCommandTiming.emptyFiltered': '没有匹配的轨迹。试试更换 IP 筛选或搜索关键词。',
  'settings.terminalCommandTiming.hostAll': '全部主机',
  'settings.terminalCommandTiming.searchPlaceholder': '搜索命令 / IP / 主机…',
  'settings.terminalCommandTiming.clearSearch': '清除搜索',
  'settings.terminalCommandTiming.clear': '清空轨迹',
  'settings.terminalCommandTiming.copy': '复制为文本',
  'settings.terminalCommandTiming.copied': '已复制',
  'settings.terminalCommandTiming.copyFailed': '复制失败',
  'settings.terminalCommandTiming.statusActive': '进行中',
  'settings.terminalCommandTiming.endReason': '结束',
  'settings.terminalCommandTiming.total': '总计',
  'settings.terminalCommandTiming.partial': '目前',
  'settings.terminalCommandTiming.barAria': '命令各阶段耗时',
  'settings.terminalCommandTiming.bottleneck': '瓶颈',
  'settings.terminalCommandTiming.segSubmitWrite': '提交→写入',
  'settings.terminalCommandTiming.segWriteOutput': '写入→首包',
  'settings.terminalCommandTiming.segOutputRender': '首包→渲染',
  'settings.terminalCommandTiming.segRenderEnd': '渲染之后',
  'settings.terminalCommandTiming.segIncomplete': '未完成',
  'settings.terminalCommandTiming.hintSubmitWrite': '瓶颈在写入 IPC 之前——主线程 / 输入路径偏慢。',
  'settings.terminalCommandTiming.hintWriteOutput': '瓶颈在等待远端首包——网络 / SSH / 远端主机。',
  'settings.terminalCommandTiming.hintOutputRender': '瓶颈在首包到 xterm 绘制之间——写队列 / 合并写 / 渲染。',
...
`,
  ...
  'vault.view.tree': '树形',
  'vault.view.home': '首页',
  'vault.opsHome.resume': '继续',
  'vault.opsHome.resumeWorkspace': '工作区 {title} · {count} 窗',
  'vault.opsHome.pinned': '已置顶',
  'vault.opsHome.recent': '最近连接',
  'vault.opsHome.segments': '按网段',
  'vault.opsHome.segmentHosts': '{count} 台主机',
  'vault.opsHome.segmentActive': '{count} 个活跃会话',
  'vault.opsHome.segmentLastConnected': '最近连接 {time}',
  'vault.opsHome.segmentNever': '暂无连接记录',
  'vault.opsHome.openWorkspace': '开工作区',
  'vault.opsHome.batchCommand': '批量命令',
  'vault.opsHome.browseTree': '树形查看',
  'vault.opsHome.empty': '暂无主机，请先导入或新建',
  'vault.opsHome.pickWorkspaceHosts': '选择工作区主机（{segment}）',
  'vault.opsHome.workspaceHostLimit': '工作区最多选择 {max} 台主机',
  ...
  'vault.hosts.connectWorkspace': '工作区 ({count})',
  'vault.hosts.connectWorkspace.success': '正在以工作区打开 {count} 个主机',
  'vault.hosts.batchExec': '批量命令 ({count})',
  'vault.hosts.batchSftp': '批量 SFTP 上传 ({count})',
  ...
  'batchExec.title': '批量执行命令',
  'batchExec.description': '在 {count} 台主机上并行执行同一条 SSH 命令，并汇总输出。',
  'batchExec.commandPlaceholder': '输入要执行的命令，例如 uptime 或 df -h',
  'batchExec.run': '执行',
  'batchExec.running': '执行中…',
  'batchExec.resultsHeading': '执行结果',
  'batchExec.summary': '成功 {success} · 失败 {failed} · 跳过 {skipped}',
  'batchExec.exitCode': '退出码 {code}',
  'batchExec.openFromWorkspace': '批量命令与结果汇总',
  'batchExec.skip.non-ssh': '仅支持 SSH 主机',
  'batchExec.skip.jump-chain': '暂不支持跳板链主机',
  'batchExec.skip.credentials': '凭证无法解密或缺失',

  'batchSftp.title': '批量 SFTP 上传',
  'batchSftp.description': '将同一批本地文件通过 SFTP 上传到 {count} 台主机。',
  'batchSftp.pickFiles': '选择文件…',
  'batchSftp.pickFilesTitle': '选择要上传的文件',
  'batchSftp.noFiles': '尚未选择文件',
  'batchSftp.filesSelected': '已选 {count} 个文件',
  'batchSftp.remoteDir': '远程目录',
  'batchSftp.run': '开始上传',
  'batchSftp.running': '上传中…',
  'batchSftp.resultsHeading': '上传结果',
  'batchSftp.summary': '成功 {success} · 失败 {failed} · 跳过 {skipped}',
  'batchSftp.skip.non-ssh': '仅支持 SSH 主机',
  'batchSftp.skip.local': '不支持本地主机',
  'batchSftp.skip.credentials': '凭证无法解密或缺失',
  ...
  // Quick Switcher
  'qs.search.placeholder': '搜索主机、标签页或 Agent 终端历史',
  'qs.jumpTo': '跳转到',
  'qs.localTerminal': '本地终端',
  'qs.localShells': '本地 Shell',
  'qs.default': '默认',
  'qs.codingCliHistory': 'Agent 终端历史',
  'qs.codingCliHistoryOpenPanel': '打开 Agent 终端历史',
  'qs.codingCliHistorySection': 'Agent 终端历史',

  // Coding CLI terminal history
  'codingCliHistory.title': 'Agent 终端历史',
  'codingCliHistory.subtitle': '关掉的本地 Claude / Codex / Grok 等工作目录',
  'codingCliHistory.searchPlaceholder': '搜索目录、标题或 CLI…',
  'codingCliHistory.filterAll': '全部',
  'codingCliHistory.empty': '还没有记录。在本地终端里运行 coding CLI 后会自动记住。',
  'codingCliHistory.emptyFiltered': '没有匹配的历史记录。',
  'codingCliHistory.open': '在此目录打开本地终端',
  'codingCliHistory.jump': '快速跳转（打开目录并启动 CLI）',
  'codingCliHistory.openShell': '仅打开目录',
  'codingCliHistory.hasResume': '可恢复会话',
  'codingCliHistory.noResume': '无 resume（将新开 CLI）',
  'codingCliHistory.status.exact': '精确恢复',
  'codingCliHistory.status.continue': '按目录继续最近会话',
  'codingCliHistory.status.fresh': '同目录新开 CLI',
  'codingCliHistory.remove': '删除',
  'codingCliHistory.pin': '置顶',
  'codingCliHistory.unpin': '取消置顶',
  'codingCliHistory.clearAll': '清空',
  'codingCliHistory.count': '共 {n} 条',
  'codingCliHistory.scanOpen': '扫描当前终端',
  'codingCliHistory.scanning': '扫描中…',
  'codingCliHistory.scanDone': '扫描完成',
  'codingCliHistory.scanResult': '扫描到 {matched} 个 Agent（新增 {added}，更新 {updated}）',
  'codingCliHistory.scanResultDetailed': '扫描到 {matched} 个（应用内 {local} · 系统 {external}；新增 {added}，更新 {updated}）',
  'codingCliHistory.scanError': '错误: {error}',

...
export const zhCNTerminalMessages: Messages = {
  ...
  'history.popup.title': '命令历史',
  'history.popup.searchPlaceholder': '输入关键字筛选历史命令…',
  'history.popup.empty': '暂无命令历史。',
  'history.popup.emptyFiltered': '没有匹配的命令。',
  'history.popup.hints': 'Enter / 双击 填入终端 · ↑↓ 选择 · Esc 关闭',
  ...
  'sftp.editor.permissionDeniedHint': '权限不足。SFTP 仍使用登录用户。请在主机设置中开启 SFTP Sudo，或在终端 sudo 后重新连接。',
  'sftp.sudo.followedTerminal': '已用 sudo 重新连接 SFTP，以便与终端用户一致。',
  'sftp.sudo.followFailed': '无法以 sudo 重新连接 SFTP。请在主机设置中开启 SFTP Sudo 并保存密码，或配置免密 sudo。',
  ...
  'settings.terminal.behavior.scrollSensitivity': '滚轮滚动速度',
  'settings.terminal.behavior.scrollSensitivity.desc':
    '鼠标滚轮每次滚动的幅度。刷屏时调低更容易停住查看，向上滚动即可暂停跟随。',
  ...
  'settings.shortcuts.conflict.message': '“{key}” 已被 “{action}” 使用。请换一组快捷键，或先释放原绑定。',
  ...
  'settings.shortcuts.binding.open-history': '打开命令历史浮层',

...
export const zhTWAiMessages: Messages = {
  ...
  'ai.chat.fast': 'Fast',
  'ai.chat.fastDesc': '啟用此模型更快、低推理的變體（如可用）。',
  'ai.chat.effort': '推理程度',
  'ai.chat.effortDesc': '控制此模型的思考/推理強度。',
  'ai.chat.effortDefault': '預設',
  ...
  'codingCli.phase.idle': '空閒',
  'codingCli.phase.busy': '執行中',
  'codingCli.phase.waiting': '等待確認',
  'codingCli.phase.completed': '已完成',
  'codingCli.phase.failed': '失敗',

...
export const enCoreMessages: Messages = {
  ...
  'settings.terminalCommandTiming.title': 'Terminal Command Timing',
  'settings.terminalCommandTiming.enable': 'Record command latency traces',
  'settings.terminalCommandTiming.enableDesc': 'When enabled, measure submit → write → first output → first render for each terminal command. Use DevTools console filter: terminal-command-timing.',
  'settings.terminalCommandTiming.hint': 'Default off. Traces are mirrored to local storage so the settings window can read what the main window records. No effect when disabled.',
  'settings.terminalCommandTiming.panelDisabled': 'Turn on the switch above to start recording. Run commands in the main terminal window — traces sync here (settings is a separate window).',
  'settings.terminalCommandTiming.recentTitle': 'Recent traces',
  'settings.terminalCommandTiming.recentDesc': 'Showing {n} · buffer {cap} · active {active}',
  'settings.terminalCommandTiming.limitOption': 'Last {n}',
  'settings.terminalCommandTiming.empty': 'No commands recorded yet. Run a command in any terminal session, then come back here.',
  'settings.terminalCommandTiming.emptyFiltered': 'No matching traces. Try another host or search query.',
  'settings.terminalCommandTiming.hostAll': 'All hosts',
  'settings.terminalCommandTiming.searchPlaceholder': 'Search command / IP / host…',
  'settings.terminalCommandTiming.clearSearch': 'Clear search',
  'settings.terminalCommandTiming.clear': 'Clear traces',
  'settings.terminalCommandTiming.copy': 'Copy as text',
  'settings.terminalCommandTiming.copied': 'Copied',
  'settings.terminalCommandTiming.copyFailed': 'Copy failed',
  'settings.terminalCommandTiming.statusActive': 'Running',
  'settings.terminalCommandTiming.endReason': 'End',
  'settings.terminalCommandTiming.total': 'total',
  'settings.terminalCommandTiming.partial': 'so far',
  'settings.terminalCommandTiming.barAria': 'Command latency stages',
  'settings.terminalCommandTiming.bottleneck': 'bottleneck',
  'settings.terminalCommandTiming.segSubmitWrite': 'Submit→Write',
  'settings.terminalCommandTiming.segWriteOutput': 'Write→Output',
  'settings.terminalCommandTiming.segOutputRender': 'Output→Render',
  'settings.terminalCommandTiming.segRenderEnd': 'After render',
  'settings.terminalCommandTiming.segIncomplete': 'Incomplete',
  'settings.terminalCommandTiming.hintSubmitWrite': 'Bottleneck before IPC write — main thread / input path is slow.',
  'settings.terminalCommandTiming.hintWriteOutput': 'Bottleneck waiting for first remote output — network / SSH / remote host.',
  'settings.terminalCommandTiming.hintOutputRender': 'Bottleneck between first output and xterm paint — write queue / coalescer / render.',
  ...
  'vault.view.home': 'Home',
  'vault.opsHome.resume': 'Resume',
  'vault.opsHome.resumeWorkspace': 'Workspace {title} · {count} panes',
  'vault.opsHome.pinned': 'Pinned',
  'vault.opsHome.recent': 'Recently connected',
  'vault.opsHome.segments': 'By subnet',
  'vault.opsHome.segmentHosts': '{count} hosts',
  'vault.opsHome.segmentActive': '{count} active sessions',
  'vault.opsHome.segmentLastConnected': 'Last connected {time}',
  'vault.opsHome.segmentNever': 'No connection history',
  'vault.opsHome.openWorkspace': 'Open workspace',
  'vault.opsHome.batchCommand': 'Batch command',
  'vault.opsHome.browseTree': 'Tree view',
  'vault.opsHome.empty': 'No hosts yet — import or create one',
  'vault.opsHome.pickWorkspaceHosts': 'Select hosts for workspace ({segment})',
  'vault.opsHome.workspaceHostLimit': 'A workspace can include at most {max} hosts',
  ...
  'batchExec.title': 'Batch command',
  'batchExec.description': 'Run the same SSH command on {count} hosts in parallel and collect output.',
  'batchExec.commandPlaceholder': 'Enter a command, e.g. uptime or df -h',
  'batchExec.run': 'Run',
  'batchExec.running': 'Running…',
  'batchExec.resultsHeading': 'Results',
  'batchExec.summary': '{success} ok · {failed} failed · {skipped} skipped',
  'batchExec.exitCode': 'exit {code}',
  'batchExec.openFromWorkspace': 'Batch command & results',

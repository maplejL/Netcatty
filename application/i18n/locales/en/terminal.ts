...
export const enTerminalMessages: Messages = {
  ...
  'history.popup.title': 'Command history',
  'history.popup.searchPlaceholder': 'Type to filter history…',
  'history.popup.empty': 'No command history yet.',
  'history.popup.emptyFiltered': 'No matching commands.',
  'history.popup.hints': 'Enter / double-click paste · ↑↓ select · Esc close',

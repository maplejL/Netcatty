...
export const enAiMessages: Messages = {
  ...
  'ai.chat.fast': 'Fast',
  'ai.chat.fastDesc': 'Prefer the faster, lower-effort variant of this model when available.',
  'ai.chat.effort': 'Effort',
  'ai.chat.effortDesc': 'Reasoning / thinking intensity for this model.',
  'ai.chat.effortDefault': 'Default',
  ...
  'topTabs.codingCliHistory': 'Agent terminal history',
  'codingCli.phase.idle': 'Idle',
  'codingCli.phase.busy': 'Running',
  'codingCli.phase.waiting': 'Waiting',
  'codingCli.phase.completed': 'Completed',
  'codingCli.phase.failed': 'Failed',

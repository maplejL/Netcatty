...
export const enVaultMessages: Messages = {
  ...
  'sftp.context.insertPathToTerminal': 'Insert path into terminal',
  ...
  'sftp.editor.permissionDeniedHint': 'Permission denied. SFTP still uses the login user. Enable SFTP Sudo on this host, or reconnect SFTP after sudo.',
  'sftp.sudo.followedTerminal': 'SFTP reconnected with sudo so it matches the terminal.',
  'sftp.sudo.followFailed': 'Could not reconnect SFTP with sudo. Enable SFTP Sudo in host settings and save a password, or allow passwordless sudo.',
  'sftp.editor.unsavedChanges': 'You have unsaved changes. Close anyway?',
  'sftp.editor.syntaxHighlight': 'Syntax Highlighting',
  'sftp.editor.compareMode': 'Compare',
  'sftp.editor.exitCompare': 'Exit compare',
  'sftp.editor.compareWithActive': 'Compare with active editor',
  ...
  // Quick Switcher
  'qs.search.placeholder': 'Search hosts, tabs, or agent terminals',
  'qs.jumpTo': 'Jump To',
  'qs.localTerminal': 'Local Terminal',
  'qs.localShells': 'Local Shells',
  'qs.default': 'Default',
  'qs.codingCliHistory': 'Agent terminals',
  'qs.codingCliHistoryOpenPanel': 'Open agent terminal history',
  'qs.codingCliHistorySection': 'Agent terminal history',

  // Coding CLI terminal history
  'codingCliHistory.title': 'Agent terminal history',
  'codingCliHistory.subtitle': 'Closed local Claude / Codex / Grok work directories',
  'codingCliHistory.searchPlaceholder': 'Search path, title, or CLI…',
  'codingCliHistory.filterAll': 'All',
  'codingCliHistory.empty': 'Nothing yet. Run a coding CLI in a local terminal and it will be remembered.',
  'codingCliHistory.emptyFiltered': 'No matching history entries.',
  'codingCliHistory.open': 'Open local terminal here',
  'codingCliHistory.jump': 'Quick jump (open folder and start CLI)',
  'codingCliHistory.openShell': 'Open folder only',
  'codingCliHistory.hasResume': 'Resumable',
  'codingCliHistory.noResume': 'No resume id (starts a new CLI)',
  'codingCliHistory.status.exact': 'Exact resume',
  'codingCliHistory.status.continue': 'Continue last in folder',
  'codingCliHistory.status.fresh': 'New CLI in folder',
  'codingCliHistory.remove': 'Remove',
  'codingCliHistory.pin': 'Pin',
  'codingCliHistory.unpin': 'Unpin',
  'codingCliHistory.clearAll': 'Clear all',
  'codingCliHistory.count': '{n} saved',
  'codingCliHistory.scanOpen': 'Scan open terminals',
  'codingCliHistory.scanning': 'Scanning…',
  'codingCliHistory.scanDone': 'Scan complete',
  'codingCliHistory.scanResult': 'Found {matched} agent(s) ({added} new, {updated} updated)',
  'codingCliHistory.scanResultDetailed': 'Found {matched} (in-app {local} · system {external}; {added} new, {updated} updated)',
  'codingCliHistory.scanError': 'Error: {error}',

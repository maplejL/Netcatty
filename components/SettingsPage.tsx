                    ...
                    {mountedTabs.has("appearance") && (
                        <SettingsLazyTab value="appearance">
                            <LazySettingsAppearanceTab
                                ...
                                setWorkTabsLocation={settings.setWorkTabsLocation}
                    ...
                    {mountedTabs.has("system") && (
                        <SettingsLazyTab value="system">
                            <LazySettingsSystemTab
                                ...
                                appLogsEnabled={settings.appLogsEnabled}
                                setAppLogsEnabled={settings.setAppLogsEnabled}
                                appLogsRetentionDays={settings.appLogsRetentionDays}
                                setAppLogsRetentionDays={settings.setAppLogsRetentionDays}
                                terminalCommandTimingDebugEnabled={settings.terminalCommandTimingDebugEnabled}
                                setTerminalCommandTimingDebugEnabled={settings.setTerminalCommandTimingDebugEnabled}

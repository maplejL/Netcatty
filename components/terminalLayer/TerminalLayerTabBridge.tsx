...
export function TerminalLayerTabBridge({ stableRef }: { stableRef: StableRef }) {
  ...
  const sidePanelLiveSnapshot = useMemo<SidePanelLiveSnapshot>(() => ({
    ...
    activeTerminalCwd,
    sftpSoftRefreshRevision: s.sftpSoftRefreshRevision ?? 0,
    sftpFollowSudoRevision: s.sftpFollowSudoRevision ?? 0,
    sftpFollowSudoSessionId: s.sftpFollowSudoSessionId ?? null,
    activeWorkspace,
    ...
    focusedHost,
    historySessionId,
    s.sftpSoftRefreshRevision,
    s.sftpFollowSudoRevision,
    s.sftpFollowSudoSessionId,
    sftpActiveHost,
  ...
  const ctx = useMemo(() => ({
    ...
    onUpdateSessionCodingCliRunPhase: s.onUpdateSessionCodingCliRunPhase,

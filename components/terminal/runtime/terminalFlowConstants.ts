...
export const MAX_TERMINAL_WRITE_QUEUE_DRAIN_BYTES_FLOOD =
  terminalFlowConstants.MAX_TERMINAL_WRITE_QUEUE_DRAIN_BYTES_FLOOD
  ?? Math.min(16384, terminalFlowConstants.MAX_TERMINAL_WRITE_QUEUE_DRAIN_BYTES);

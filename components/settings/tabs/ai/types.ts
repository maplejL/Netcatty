...
export interface NetcattyAiBridge {
  ...
  aiSdkAgentListModels?: (sdkBackend: string, cwd?: string, providerId?: string, chatSessionId?: string, agentEnv?: Record<string, string>, agentCommand?: string) => Promise<{ ok: boolean; models?: Array<{ id: string; name: string; description?: string; thinkingLevels?: string[]; thinkingParamId?: string; supportsFast?: boolean; fastParams?: Array<{ id: string; value: string }> }>; currentModelId?: string | null; error?: string }>;
...
export type SettingsIconId = AIProviderId | "claude" | "copilot" | "codebuddy" | "workbuddy" | "opencode";
...
export const SETTINGS_ICON_PATHS: Record<SettingsIconId, string> = {
  ...
  workbuddy: "/ai/agents/workbuddy.svg",
